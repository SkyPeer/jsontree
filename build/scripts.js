...
function (_Component) {
  ...
  function PageComponent() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "checkIsActiveCheck", function (isActiveArg) {
      var result = _this.state.needIsActiveCheck ? isActiveArg : true;
      return result;
    });
  ...
  _createClass(PageComponent, [{
    ...
    value: function getAllData() {
      ...
      fetch("/getDefaultJsonData").then(function (res) {
        return res.json();
      }).then(function (json) {
        return _this2.buildTree(json);
      });
    }
  }, {
...
}(react__WEBPACK_IMPORTED_MODULE_0__["Component"]); // endofcomponent


react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(PageComponent, null), document.getElementById('index'));
